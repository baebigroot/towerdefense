//NOM prénom étudiant 1 : Lovanomena RAFIDISON
//NOM prénom étudiant 2 : Nhung NGUYEN
...
int main(int argc, char* argv[])
{
    ...
    if ( pSpriteTourSol )  //si le permier sprite a bien été chargé, on suppose que les autres aussi
    {
        ...
        while ( cont != 0 ){   //VOUS DEVEZ GERER (DETECTER) LA FIN DU JEU -> tourRoiDetruite
                ...
                //REMETTRE LE CHAMP PEUTATTAQUER À 1
                ...
                maj_fenetre(pWindow);
                SDL_Delay(50);  //valeur du délai à modifier éventuellement
